...
public class PixelMap 
{
	...
	protected void AllocateMemory(ImageType type, int h, int w)
	{
		...
		switch (type){
		case BW : 
			imageData =  new BWPixel[height][width];
			break;
			
		case Gray : 
			
			imageData =  new GrayPixel[height][width];
			break;
			
		case Color : 
			
			imageData =  new ColorPixel[height][width];
			break;
			
		case Transparent : 
			
			imageData =  new TransparentPixel[height][width];
			break;			
